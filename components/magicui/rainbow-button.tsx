...
type MergeProps = Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, keyof MotionProps> & MotionProps;

export const RainbowButton = React.forwardRef<HTMLButtonElement, MergeProps>(
